...
\keywords{Sensory Substitution, Tactile Feedback, Wearable Device} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
...
\begin{itemize}
	\item the current position of the car relative to the center of the road,
	\item the current position of the car relative to the road on current trajectory after t+4.0 seconds, and
	\item the positional information of obstacles.
\end{itemize}
